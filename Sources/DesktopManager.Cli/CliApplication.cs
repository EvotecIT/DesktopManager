...
internal static class CliApplication {
    ...
    internal static int Run(string[] args, TextWriter output, TextWriter error) {
        ...
        try {
            ...
            return group switch {
                ...
                "workstation" => WorkstationCommands.Run(action, parsed),
                "audio" => AudioCommands.Run(action, parsed),
                "system" => SystemCommands.Run(action, parsed),
                "personalization" => PersonalizationCommands.Run(action, parsed),
                "taskbar" => TaskbarCommands.Run(action, parsed),
                "radio" => RadioCommands.Run(action, parsed),
                "wifi" => WifiCommands.Run(action, parsed),
                "device" => DeviceCommands.Run(action, parsed),
                "driver" => DriverCommands.Run(action, parsed),
                "virtual-desktop" => VirtualDesktopCommands.Run(action, parsed),
                ...
                "visual" => VisualCommands.Run(action, parsed),
    ...
    internal static string GetHelpText(string? topic) {
        return topic?.ToLowerInvariant() switch {
            ...
            "workstation" => HelpText.GetWorkstationHelp(),
            "audio" => HelpText.GetAudioHelp(),
            "system" => HelpText.GetSystemHelp(),
            "personalization" => HelpText.GetPersonalizationHelp(),
            "taskbar" => HelpText.GetTaskbarHelp(),
            "radio" => HelpText.GetRadioHelp(),
            "wifi" => HelpText.GetWifiHelp(),
            "device" => HelpText.GetDeviceHelp(),
            "driver" => HelpText.GetDriverHelp(),
            "virtual-desktop" => HelpText.GetVirtualDesktopHelp(),
            "process" => HelpText.GetProcessHelp(),
            "screenshot" => HelpText.GetScreenshotHelp(),
            "target" => HelpText.GetTargetHelp(),
            "visual" => HelpText.GetVisualHelp(),
