...
internal sealed class WindowHotkeyActionExecutor {
    ...
    public HotkeyExecutionResult Execute(HotkeyFunctionDefinition function, IntPtr targetWindowHandle) {
        ...
        try {
            global::DesktopManager.WindowPlacementRequest request = CreatePlacementRequest(function.WindowAction, targetWindowHandle);
    ...
    private static global::DesktopManager.WindowPlacementRequest CreatePlacementRequest(WindowHotkeyActionDefinition action, IntPtr targetWindowHandle) {
