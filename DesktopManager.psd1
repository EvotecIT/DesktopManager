@{
    ...
    CmdletsToExport        = @('Get-DesktopMonitor', 'Get-DesktopWallpaper', 'Get-DesktopWindow', 'Set-DesktopPosition', 'Set-DesktopWallpaper', 'Set-DesktopWindowPosition', 'Set-DesktopWindowState')
    CompanyName            = 'Evotec'
